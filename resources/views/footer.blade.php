...
<div class="container py-5">
  <div class="row g-5">
    <div class="col-lg-3 col-md-6">
      ...
      <p>
        Maintera is a maintenance management system designed to streamline service bookings, technician assignments, and customer interactions.
      </p>
    ...
    <div class="col-lg-3 col-md-6">
      ...
      <p>
        <i class="fa fa-map-marker-alt me-3"></i>G 7 Markaz Islamabad.
      </p>
      <p><i class="fa fa-phone-alt me-3"></i>+923405591200</p>
      <p><i class="fa fa-envelope me-3"></i>maintera@gmail.com</p>
    </div>
    <div class="col-lg-3 col-md-6">
