            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-5">
                            Maintera specializes in providing reliable and cost-effective maintenance services. From urgent
                            repairs to scheduled inspections, we cover a wide range of solutions to keep your home and
                        ...
                        <div class="row gy-5 gx-4">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                                ...
                                <span>From plumbing to electrical repairs, we cover it all.</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <span>Serving homes and industries with excellence.</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <span>We take pride in our customer satisfaction.</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <span>Get the best services at affordable prices.</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="owl-carousel testimonial-carousel">
                            <div class="testimonial-item">
                                <img class="img-fluid mb-4" src="img/testimonial-1.jpg" alt="Client Testimonial" />
                                <p class="fs-5">
                            ...
                            <div class="testimonial-item">
                                <img class="img-fluid mb-4" src="img/testimonial-2.jpg" alt="Client Testimonial" />
                                <p class="fs-5">
