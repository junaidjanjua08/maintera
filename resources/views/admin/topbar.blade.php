        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                <button
                    ...
                    onclick="toggleNotificationsMenu()" aria-label="Notifications" aria-haspopup="true">
                ...
                <div id="notificationsMenu" class="hidden absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700">
                    <div class="flex">
